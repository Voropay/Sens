...
import org.sens.core.concept.{Attribute, DataSourceConcept, ParentConcept, UnionConcept}
...
class UnionConceptInferenceTests extends AnyFlatSpec with Matchers {

  "Union Concept definition" should "infer attributes expressions correctly" in {
    ...
    conDef.inferAttributeExpressions(context).get should equal (UnionConcept(
      "conceptA",
      ParentConcept(ConceptReference("conceptB"), Some("pcB"), Map(), Nil) ::
        ParentConcept(AnonymousConceptDefinition.builder(
